...
// === Middleware ===
apiApp.use(cors({ origin: 'http://13.203.104.102:8204', credentials: true }));
...
apiServer.listen(API_PORT, () =>
  console.log(`✅ Server + WebSocket running on http://13.203.104.102:${API_PORT}`)
);
...
loginApp.listen(LOGIN_PORT, () =>
  console.log(`🚪 Login Page running on http://13.203.104.102:${LOGIN_PORT}`)
);
